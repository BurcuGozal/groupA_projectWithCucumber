...
@CucumberOptions (
		...
		tags = "@nihal",    //"@negative or @smoke", "@smoke and @negative and @login"
...
//		,dryRun = false  // to run the test without launching, we need this to generate step def snippets
